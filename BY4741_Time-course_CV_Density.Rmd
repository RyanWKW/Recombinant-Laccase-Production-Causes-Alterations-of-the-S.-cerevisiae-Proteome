...
CVS <- read_xlsx("Z:/mayor_lab/RyanWong/+_-_Laccase/BY4741/Supplemental File 2 - Proteins Quantified.xlsx", sheet = 2)
CVS <- CVS[,s]
CVS <- t(CVS)
...
ggsave(paste(name, ".jpg", sep = ""), device = "jpg", path = "Z:/mayor_lab/RyanWong/+_-_Laccase/BY4741/", units = "cm", width = 20, height = 10, dpi = 600)

ggsave(paste(name, ".svg", sep = ""), device = "svg", path = "Z:/mayor_lab/RyanWong/+_-_Laccase/BY4741/", units = "cm", width = 20, height = 10, dpi = 600)
